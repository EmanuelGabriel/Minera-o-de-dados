...
# Mineração de dados dos presos do Brasil/Piauí
# Criado na data: Segunda-feira - 19/02/2018
# Autor: Emanuel A. Gabriel
# Mineração de dados jurídicos de presos do Estado do Piauí
...
# Informações dos estados da Federação Brasileira
# AC AL AP AM BA CE DF ES GO MA MT MS MG PA PB PR PE PI RJ RN RS RO RR SC SP SE TO
# Escolhendo o Estado para busca de informações
uf = 'PI'
